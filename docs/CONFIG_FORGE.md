...
vwarp --config config/examples/sample-working.json --masque

# Copy and customize for your needs
cp config/examples/sample-working.json my-config.json
...
vwarp --config config/examples/basic-obfuscation.json --masque
vwarp --config config/examples/moderate-obfuscation.json --masque
vwarp --config config/examples/heavy-obfuscation.json --masque

# CLI presets (no config file needed)
vwarp --masque --noize-preset moderate

# Use with proxy chaining for maximum privacy
vwarp --config config/examples/sample-working.json --proxy socks5://127.0.0.1:1080
```
...
1. Copy an example config: `cp config/examples/moderate-obfuscation.json my-custom.json`
...
vwarp --config config/examples/sample-working.json --masque --verbose
...
1. **Copy a base config**: `cp config/examples/moderate-obfuscation.json my-custom.json`
